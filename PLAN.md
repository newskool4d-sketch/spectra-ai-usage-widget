...
- Windows는 430×720 미니 창으로 시작하고, 트레이 메뉴에서 1280×860 대시보드로 전환합니다. 닫기 버튼은 프로세스를 종료하지 않고 트레이로 숨깁니다. 대시보드 설정의 "메모리 절약 대기"(기본 off)를 켜면 닫을 때 WebView 창을 종료하고, 트레이 클릭 시 테마·창 모드·마지막 스냅샷을 복원해 다시 만듭니다.
